...
void Init_I2C2(void)
{
   LL_GPIO_SetAFPin_8_15   (PIN_SENSOR_I2C2_SCL_PORT, PIN_SENSOR_I2C2_SCL_PIN, PIN_SENSOR_I2C2_SCL_AF);
   LL_GPIO_SetPinOutputType(PIN_SENSOR_I2C2_SCL_PORT, PIN_SENSOR_I2C2_SCL_PIN, LL_GPIO_OUTPUT_OPENDRAIN);
   LL_GPIO_SetPinSpeed     (PIN_SENSOR_I2C2_SCL_PORT, PIN_SENSOR_I2C2_SCL_PIN, LL_GPIO_SPEED_HIGH);

   LL_GPIO_SetAFPin_8_15   (PIN_SENSOR_I2C2_SDA_PORT, PIN_SENSOR_I2C2_SDA_PIN, PIN_SENSOR_I2C2_SDA_AF);
   LL_GPIO_SetPinOutputType(PIN_SENSOR_I2C2_SDA_PORT, PIN_SENSOR_I2C2_SDA_PIN, LL_GPIO_OUTPUT_OPENDRAIN);
   LL_GPIO_SetPinSpeed     (PIN_SENSOR_I2C2_SDA_PORT, PIN_SENSOR_I2C2_SDA_PIN, LL_GPIO_SPEED_HIGH);

   LL_GPIO_SetPinMode(PIN_SENSOR_I2C2_PWR_PORT, PIN_SENSOR_I2C2_PWR_PIN, LL_GPIO_MODE_OUTPUT);
   LL_GPIO_SetOutputPin(PIN_SENSOR_I2C2_PWR_PORT, PIN_SENSOR_I2C2_PWR_PIN);

   LL_I2C_Disable(I2C2_SENSOR);

   MODIFY_REG  (I2C2_SENSOR->TIMINGR, I2C_TIMINGR_PRESC,  0);
   MODIFY_REG  (I2C2_SENSOR->TIMINGR, I2C_TIMINGR_SCLL,   0x09 << I2C_TIMINGR_SCLL_Pos);
   MODIFY_REG  (I2C2_SENSOR->TIMINGR, I2C_TIMINGR_SCLH,   0x03 << I2C_TIMINGR_SCLH_Pos);
   MODIFY_REG  (I2C2_SENSOR->TIMINGR, I2C_TIMINGR_SDADEL, 0x01 << I2C_TIMINGR_SDADEL_Pos);
   MODIFY_REG  (I2C2_SENSOR->TIMINGR, I2C_TIMINGR_SCLDEL, 0x01 << I2C_TIMINGR_SCLDEL_Pos);
   SET_BIT     (I2C2_SENSOR->CR1,     I2C_CR1_ANFOFF);

   LL_I2C_Enable(I2C2_SENSOR);
}
