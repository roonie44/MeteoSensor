...
void Init_LogUSART(void)
{
   ...
   LL_GPIO_SetPinPull(PIN_LOG_USART_PORT, PIN_LOG_USART_RX_PIN, LL_GPIO_PULL_UP);
...
void Init_SensorI2C(void)
{
  ...
  // LL_GPIO_SetPinMode      (PIN_SENSOR_I2C_SDA_PORT, PIN_SENSOR_I2C_SDA_PIN, LL_GPIO_MODE_ALTERNATE);
   ...
   LL_GPIO_SetPinMode      (PIN_SENSOR_I2C_PWR_PORT, PIN_SENSOR_I2C_PWR_PIN, LL_GPIO_MODE_OUTPUT);
